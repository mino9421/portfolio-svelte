import{A as e}from"./UIcon.d210f063.js";import{g as t}from"./skills.addfd2eb.js";const n=`# Dungeon Crawler Jam 2024: Nightmare of the Gazer
...
`,o=""+new URL("../assets/portfolio_1.4e77044e.png",import.meta.url).href,r=""+new URL("../assets/portfolio_2.de7ee586.png",import.meta.url).href,l=""+new URL("../assets/portfolio_3.a4923f07.png",import.meta.url).href,c=""+new URL("../assets/portfolio_4.c9a971d8.png",import.meta.url).href,d=""+new URL("../assets/gazer_1.367797c4.png",import.meta.url).href,m=""+new URL("../assets/gazer_2.e7e46c3e.png",import.meta.url).href,p=""+new URL("../assets/gazer_3.05daa496.png",import.meta.url).href,u=[{slug:"portfolio-svelte",color:"#5e95e3",description:a,shortDescription:"A modular and customizable portfolio built with SvelteKit, TypeScript, and Tailwind CSS, allowing users to easily manage and expand their portfolio by adding skills, projects, experience, and education via Markdown files.",links:[{to:"https://github.com/mino9421/portfolio-svelte",label:"GitHub"}],logo:e.Svelte,name:"Slick Portfolio",period:{from:new Date(2024,8,25),to:new Date(2024,9,3)},skills:t("svelte","ts","js","tailwind","unocss","sass","node","html"),type:"Website Template",screenshots:[{label:"1",src:o},{label:"2",src:r},{label:"3",src:l},{label:"4",src:c}]},{slug:"deez",color:"#ff3e00",description:i,shortDescription:"A social media platform built with Next.js, tRPC, and Prisma, where users communicate solely through emojis. It features modern tools like Tailwind CSS, Drizzle, and NextAuth.js for a seamless and secure experience.",links:[{to:"https://github.com/mino9421/deez-book",label:"GitHub"}],logo:e.ReactJs,name:"Deez",period:{from:new Date(2024,4,10),to:new Date(2024,4,20)},skills:t("reactjs","ts","js","tailwind","prisma","vite","trpc","drizzle"),type:"Website Template"},{slug:"Gazer",color:"#ff3e00",description:n,shortDescription:"Semi-Procedural RPG Dungeon Crawler: Infinity",links:[{to:"https://brineshrimp.itch.io/nightmare-of-the-gazer",label:"itch.io"}],logo:e.Unity,name:"Gazer",period:{from:new Date(2024,3,22),to:new Date(2024,3,31)},skills:t("unity","csharp"),type:"Website Template",screenshots:[{label:"1",src:d},{label:"2",src:m},{label:"3",src:p}]},{slug:"Poker Ultimte Texas Hold'em",color:"#ff3e00",description:s,shortDescription:"Built with Vue.js and Nuxt.js, this Ultimate Texas Hold'em Poker game lets players compete against a computer dealer with realistic gameplay and dynamic betting rounds.",links:[{to:"https://brineshrimp.itch.io/nightmare-of-the-gazer",label:"itch.io"}],logo:e.Nuxt,name:"Poker Ultimte Texas Hold'em",period:{from:new Date(2024,8,1),to:new Date(2024,8,10)},skills:t("ts","vue","nuxt","tailwind","unocss","vite","vitest"),type:"Website Template"}],f="Projects";export{u as i,f as t};
