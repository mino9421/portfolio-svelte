import{A as n}from"./UIcon.db59d7b1.js";const p=`# JavaScript
...
`,P=`Flutter is an open-source UI software development kit created by Google. It is used to develop cross platform applications from a single codebase for any web browser, Fuchsia, Android, iOS, Linux, macOS, and Windows. First described in 2015, Flutter was released in May 2017.
`,j=`# Angular
...
`,R=`Deno /diːnoʊ/is a runtime for JavaScript, TypeScript, and WebAssembly that is based on the V8 JavaScript engine and the Rust programming language. Deno was co-created by Ryan Dahl, who also created Node.js.
...
`;function N(i,...t){const o=Object.assign({},i);return Object.keys(o).forEach(s=>{t.includes(s)&&delete o[s]}),o}const a=i=>i,J=[a({name:"Programming Languages",slug:"pro-lang"}),a({name:"Frameworks",slug:"framework"}),a({name:"Libraries",slug:"library"}),a({name:"Langauges",slug:"lang"}),a({name:"Databases",slug:"db"}),a({name:"ORMs",slug:"orm"}),a({name:"DevOps",slug:"devops"}),a({name:"Testing",slug:"test"}),a({name:"Dev Tools",slug:"devtools"}),a({name:"Markup & Style",slug:"markup-style"}),a({name:"Design",slug:"design"}),a({name:"Soft Skills",slug:"soft"}),a({name:"Environments & Runtimes",slug:"env"})],e=i=>{const t=N(i,"category");return i.category&&(t.category=J.find(o=>o.slug===i.category)),t},c=[e({slug:"js",color:"yellow",description:p,logo:n.JavaScript,name:"Javascript",category:"pro-lang"}),e({slug:"ts",color:"blue",description:g,logo:n.TypeScript,name:"Typescript",category:"pro-lang"}),e({slug:"java",color:"red",description:u,logo:n.Java,category:"pro-lang",name:"Java"}),e({slug:"c",color:"purple",description:T,logo:n.C,category:"pro-lang",name:"C"}),e({slug:"c++",color:"purple",description:D,logo:n.Cpp,category:"pro-lang",name:"C++"}),e({slug:"csharp",color:"purple",description:h,logo:n.Csharp,category:"pro-lang",name:"C#"}),e({slug:"python",color:"yellow",description:f,logo:n.Python,category:"pro-lang",name:"Python"}),e({slug:"rust",color:"orange",description:A,logo:n.Rust,name:"Rust",category:"pro-lang"}),e({slug:"go",color:"cyan",description:m,logo:n.Go,name:"Go",category:"pro-lang"}),e({slug:"php",color:"cyan",description:M,logo:n.Php,name:"PHP",category:"pro-lang"}),e({slug:"reactjs",color:"cyan",description:y,logo:n.ReactJs,category:"library",name:"React Js"}),e({slug:"unity",color:"cyan",description:z,logo:n.Unity,category:"framework",name:"Unity"}),e({slug:"vue",color:"green",description:w,logo:n.VueJs,category:"framework",name:"VueJs"}),e({slug:"nuxt",color:"green",description:k,logo:n.Nuxt,category:"framework",name:"Nuxt"}),e({slug:"remix",color:"white",description:v,logo:n.Remix,category:"framework",name:"Remix"}),e({slug:"laravel",color:"white",description:C,logo:n.Laravel,category:"framework",name:"Laravel"}),e({slug:"svelte",color:"orange",description:b,logo:n.Svelte,category:"library",name:"Svelte"}),e({slug:"angular",color:"red",description:j,logo:n.Angular,category:"framework",name:"Angular"}),e({slug:"electron",color:"purple",description:x,logo:n.Electron,name:"Electron JS",category:"library"}),e({slug:"flutter",color:"green",description:P,logo:n.Flutter,category:"framework",name:"Flutter"}),e({slug:"solid",color:"blue",description:"",logo:n.SolidJs,category:"library",name:"Solid JS"}),e({slug:"quasar",color:"purple",description:"",logo:n.Quasar,category:"framework",name:"Quasar"}),e({slug:"xamarin",color:"purple",description:S,logo:n.Xamarin,category:"framework",name:"Xamarin"}),e({slug:"node",color:"green",description:I,logo:n.NodeJs,category:"env",name:"Node JS"}),e({slug:"trpc",color:"green",description:E,logo:n.Trpc,category:"env",name:"Trpc"}),e({slug:"deno",color:"white",description:R,logo:n.Deno,name:"Deno",category:"env"}),e({slug:"fastify",color:"fastify",description:U,logo:n.Fastify,name:"Fastify",category:"framework"}),e({slug:"express",color:"white",description:"",logo:n.ExpressJs,name:"Express JS",category:"framework"}),e({slug:"honojs",color:"orange",description:L,logo:n.HonoJs,name:"Hono JS",category:"framework"}),e({slug:"postgresql",color:"blue",description:"",logo:n.PostgreSQL,name:"PostgreSQL",category:"db"}),e({slug:"firebase",color:"orange",description:"",logo:n.Firebase,name:"Firebase",category:"db"}),e({slug:"mongodb",color:"green",description:"",logo:n.MongoDB,name:"MongoDB",category:"db"}),e({slug:"redis",color:"red",description:"",logo:n.Redis,category:"db",name:"Redis"}),e({slug:"neo4j",color:"blue",description:"",logo:n.Neo4j,category:"db",name:"Neo4j"}),e({slug:"prisma",color:"darkcyan",description:O,logo:n.Prisma,name:"Prisma",category:"orm"}),e({slug:"drizzle",color:"darkcyan",description:F,logo:n.Drizzle,name:"Drizzle",category:"orm"}),e({slug:"docker",color:"blue",description:"",logo:n.Docker,name:"Docker",category:"devops"}),e({slug:"kubernetes",color:"purple",description:"",logo:n.Kubernetes,name:"Kubernetes",category:"devops"}),e({slug:"vite",color:"purple",description:"",logo:n.Vite,name:"Vite",category:"devtools"}),e({slug:"vitest",color:"green",description:"",logo:n.Vitest,name:"Vitest",category:"test"}),e({slug:"jest",color:"green",description:"",logo:n.Jest,name:"Jest",category:"test"}),e({slug:"playwright",color:"green",description:"",logo:n.Playwright,name:"Playwright",category:"test"}),e({slug:"html",color:"orange",description:"",logo:n.HTML,name:"HTML",category:"markup-style"}),e({slug:"css",color:"blue",description:"",logo:n.CSS,name:"CSS",category:"markup-style"}),e({slug:"postcss",color:"red",description:"",logo:n.Postcss,name:"PostCSS",category:"markup-style"}),e({slug:"unocss",color:"gray",description:"",logo:"https://unocss.dev/logo.svg",name:"UnoCSS",category:"markup-style"}),e({slug:"sass",color:"pink",description:"",logo:n.Sass,name:"Sass",category:"markup-style"}),e({slug:"tailwind",color:"cyan",description:"",logo:n.Tailwind,name:"Tailwind",category:"markup-style"}),e({slug:"ps",color:"cyan",description:"",logo:n.Photoshop,name:"Adobe Photoshop",category:"design"}),e({slug:"ae",color:"purple",description:"",logo:n.AfterEffects,name:"Adobe After Effects",category:"design"}),e({slug:"pp",color:"pink",description:"",logo:n.Premiere,name:"Adobe Premiere",category:"design"}),e({slug:"ai",color:"orange",description:"",logo:n.Illustrator,name:"Adobe Illustrator",category:"design"})],V="Skills",H=(...i)=>c.filter(t=>i.includes(t.slug)),G=i=>{const t=[],o=[];return c.forEach(s=>{if(i.trim()&&!s.name.toLowerCase().includes(i.trim().toLowerCase()))return;if(!s.category){o.push(s);return}let r=t.find(d=>{var l;return d.category.slug===((l=s.category)==null?void 0:l.slug)});r||(r={items:[],category:s.category},t.push(r)),r.items.push(s)}),o.length!==0&&t.push({category:{name:"Others",slug:"others"},items:o}),t};export{G as a,H as g,c as i,V as t};
